...
public class BlimpStructure extends Structure<NoFeatureConfig> {
    ...
    public static class Start extends StructureStart<NoFeatureConfig>
    {
        ...
        {
            int x = chunkX * 16;
            int z = chunkZ * 16; // TODO work out the kinks with generation + entity spawning inside
            BlockPos blockposBaseTower = new BlockPos(x, 0, z);

            JigsawManager.addPieces(dynamicRegistryManager,
                    new VillageConfig(() -> dynamicRegistryManager.registryOrThrow(Registry.TEMPLATE_POOL_REGISTRY)
                            .get(new ResourceLocation(Main.MODID, "blimp/start_pool1")),
            ...
            LogManager.getLogger().log(Level.DEBUG, "Blimp at " +
