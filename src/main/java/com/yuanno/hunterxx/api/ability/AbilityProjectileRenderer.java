...
import com.yuanno.hunterxx.models.CubeModel;
...
public class AbilityProjectileRenderer<T extends AbilityProjectileEntity, M extends EntityModel<T>> extends EntityRenderer<T>
{
	...
	public static class Factory implements IRenderFactory<AbilityProjectileEntity>
	{
		...
		public Factory setTexture(String attribute, String textureName)
		{
			this.texture = new ResourceLocation(Main.MODID, "textures/entities/projectiles/" + attribute + "/" + textureName + ".png");
			return this;
		}
