...
import com.yuanno.hunterxx.api.ability.interfaces.IBodyOverlayAbility;
import com.yuanno.hunterxx.api.ability.interfaces.IPunchOverlayAbility;
...
import com.yuanno.hunterxx.api.ability.sorts.ExplosionAbility;
import com.yuanno.hunterxx.api.ability.sorts.RepeaterAbility;
...
public class AbilityHelper {
    ...
    public static List<BlockPos> createEmptyCube(World world, double posX, double posY, double posZ, int sizeX, int sizeY, int sizeZ, Block blockToPlace)
    {
