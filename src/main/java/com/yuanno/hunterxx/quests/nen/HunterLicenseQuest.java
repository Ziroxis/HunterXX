...
public class HunterLicenseQuest extends Quest {
    //private Objective obtainFur = new ObtainItemObjective("Obtain 3 foxbear fur", 3, ModItems.FOXBEAR_FUR.get());
    private Objective healingPotion = new BrewPotionObjective("Brew a healing potion", 1, new Effect[] {Effects.HEAL});
    private Objective obtainHeart = new ObtainItemObjective("Obtain a heart of the sea", 1, Items.HEART_OF_THE_SEA);
