...
public class BasicKillingQuest06 extends Quest {

    private static final KillEntityObjective.ICheckKill TARGET_CHECK = (player, target, source) ->
    {
        return target.getType() == EntityType.WITHER;
    };

    private Objective killObjective = new KillEntityObjective("Kill the wither", 1, TARGET_CHECK);

    public BasicKillingQuest06()
    {
        super("basickillingquest06", "Killing the wither");
        this.setDescription("Kill the wither");
