...
import com.yuanno.hunterxx.networking.client.CEquipAbilityPacket;
import com.yuanno.hunterxx.networking.client.CToggleCombatModePacket;
import com.yuanno.hunterxx.networking.client.CTogglePassiveAbilityPacket;
...
public class AbilitiesListScreenPanel extends ScrollPanel
{
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks)
    {
		...
		if (true && this.isMouseOver(mouseX, mouseY))
		{
			...
			float manaCost = hoveredEntity.ability.getauraCost();
			...
			List<IReorderingProcessor> stringsMana = this.parent.getMinecraft().font.split(new StringTextComponent("Aura cost: " + manaCost), 210);
