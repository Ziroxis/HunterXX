...
public class BasicTransmutationModel<T extends LivingEntity> extends BipedModel<T> {
    ...
    public BasicTransmutationModel() {
        ...
        Sharp.setPos(0.0F, 19.0F, 0.0F);
        Sharp.texOffs(48, 8).addBox(-7.0F, 2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(24, 0).addBox(4.0F, 2.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(48, 4).addBox(-7.0F, -4.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(44, 0).addBox(4.0F, -4.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(0, 48).addBox(-11.0F, -12.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(47, 14).addBox(8.0F, -12.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(40, 46).addBox(8.0F, -17.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(32, 44).addBox(-11.0F, -17.0F, -1.0F, 3.0F, 2.0F, 2.0F, 0.0F, false);
        Sharp.texOffs(24, 4).addBox(-3.0F, 3.0F, -3.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        Sharp.texOffs(20, 16).addBox(1.0F, 3.0F, -3.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        Sharp.texOffs(41, 41).addBox(1.0F, -12.0F, -5.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(41, 36).addBox(-3.0F, -12.0F, -5.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(40, 31).addBox(-7.0F, -15.0F, -5.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(40, 26).addBox(5.0F, -15.0F, 2.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(40, 16).addBox(-7.0F, -15.0F, 2.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(0, 3).addBox(-7.0F, -7.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        Sharp.texOffs(0, 0).addBox(5.0F, -7.0F, -1.0F, 2.0F, 2.0F, 1.0F, 0.0F, false);
        Sharp.texOffs(40, 21).addBox(5.0F, -15.0F, -5.0F, 2.0F, 2.0F, 3.0F, 0.0F, false);
        Sharp.texOffs(32, 38).addBox(4.0F, -21.0F, -2.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);
        Sharp.texOffs(32, 32).addBox(-6.0F, -21.0F, -2.0F, 2.0F, 2.0F, 4.0F, 0.0F, false);    }
